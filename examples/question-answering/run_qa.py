...
def main():
    ...
    def my_hp_space_optuna(trial):
        return {
            ...
            "lr_scheduler_type":trial.suggest_categorical("lr_scheduler_type", [str(SchedulerType.LINEAR), str(SchedulerType.COSINE), str(SchedulerType.COSINE_WITH_RESTARTS)]),
        }
